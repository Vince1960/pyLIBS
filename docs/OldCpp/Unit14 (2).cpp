...
if((fabs(atof(Form14->Edit6->Text.c_str()))!= SDIAppForm->Series4->XValues->Value[firstlin] && fabs(atof(Form14->Edit6->Text.c_str()))!=fabs(Form6->Table1->FieldByName("fitwavelen")->AsFloat)))
{
condizioni();
}
void manfit();
...
void condizioni();
 Form14->Edit2->Text="Moving to next region";
   Form14->ProgressBar1->Position=0;
  SDIAppForm->Edit7->Text="0";
  float jmin = atoi((SDIAppForm->Edit10->Text).c_str());
   float jmax = atoi((SDIAppForm->Edit11->Text).c_str());
     int j = atoi((SDIAppForm->Edit12->Text).c_str());
  if (j < jmax)
    {
      j++;
...
{
if (Form14->Width==420) Form14->Width=178;
else {Form14->Width=420;
...
//---------------------------------------------------------------------------
  ...
  /* lunghezze d'onda */
      ...
      if (Form6->Table1->FieldByName("fitwavelen")->AsFloat !=0.0)
      {
       a[k*3]= fabs(Form6->Table1->FieldByName("fitwavelen")->AsFloat);
       if (Form6->Table1->FieldByName("fitwavelen")->AsFloat<0)
       {
       fix[0]=1;
       }
      else      {
     ...
     /* larghezze gaussiane */
      ...
      if (Form6->Table1->FieldByName("wg")->AsFloat!=0)
      {
       ...
       fix[1]=1;
                ...
                a[1+k*3]= atof(OKBottomDlg->Edit14->Text.c_str());
                fix[1]=0;
                }
       ...
       if (Form6->Table1->FieldByName("wl")->AsFloat!=0)
      {
       ...
       fix[2]=1;
                ...
                a[2+k*3]= atof(OKBottomDlg->Edit15->Text.c_str());
                fix[2]=0;
                }
...
{Edit6->Color=clRed;
 Form6->Table1->FieldValues["fitwavelen"]=-atof(Form14->Edit6->Text.c_str());
 }
 else
...
{Edit9->Color=clRed;
 Form6->Table1->FieldValues["fitwavelen"]=-atof(Form14->Edit9->Text.c_str());
 }
 else
...
{Edit12->Color=clRed;
 Form6->Table1->FieldValues["fitwavelen"]=-atof(Form14->Edit12->Text.c_str());
 }
 else
...
{Edit15->Color=clRed;
 Form6->Table1->FieldValues["fitwavelen"]=-atof(Form14->Edit15->Text.c_str());
 }
 else
...
{Edit18->Color=clRed;
 Form6->Table1->FieldValues["fitwavelen"]=-atof(Form14->Edit18->Text.c_str());
 }
 else
...
{Edit21->Color=clRed;
 Form6->Table1->FieldValues["fitwavelen"]=-atof(Form14->Edit21->Text.c_str());
 }
 else
...
{Edit24->Color=clRed;
 Form6->Table1->FieldValues["fitwavelen"]=-atof(Form14->Edit24->Text.c_str());
 }
 else
...
{Edit27->Color=clRed;
 Form6->Table1->FieldValues["fitwavelen"]=-atof(Form14->Edit27->Text.c_str());
 }
 else
...
{Edit30->Color=clRed;
 Form6->Table1->FieldValues["fitwavelen"]=-atof(Form14->Edit30->Text.c_str());
 }
 else
...
{Edit33->Color=clRed;
 Form6->Table1->FieldValues["fitwavelen"]=-atof(Form14->Edit33->Text.c_str());
 }
 else
...
{Edit7->Color=clRed;
 Form6->Table1->FieldValues["wg"]=-atof(Form14->Edit7->Text.c_str());
 }
 else
...
{Edit10->Color=clRed;
 Form6->Table1->FieldValues["wg"]=-atof(Form14->Edit10->Text.c_str());
 }
 else
...
{Edit13->Color=clRed;
 Form6->Table1->FieldValues["wg"]=-atof(Form14->Edit13->Text.c_str());
 }
 else
...
{Edit16->Color=clRed;
 Form6->Table1->FieldValues["wg"]=-atof(Form14->Edit16->Text.c_str());
 }
 else
...
{Edit19->Color=clRed;
 Form6->Table1->FieldValues["wg"]=-atof(Form14->Edit19->Text.c_str());
 }
 else
...
{Edit22->Color=clRed;
 Form6->Table1->FieldValues["wg"]=-atof(Form14->Edit22->Text.c_str());
 }
 else
...
{Edit25->Color=clRed;
 Form6->Table1->FieldValues["wg"]=-atof(Form14->Edit25->Text.c_str());
 }
 else
...
{Edit28->Color=clRed;
 Form6->Table1->FieldValues["wg"]=-atof(Form14->Edit28->Text.c_str());
 }
 else
...
{Edit31->Color=clRed;
 Form6->Table1->FieldValues["wg"]=-atof(Form14->Edit31->Text.c_str());
 }
 else
...
{Edit34->Color=clRed;
 Form6->Table1->FieldValues["wg"]=-atof(Form14->Edit34->Text.c_str());
 }
 else
...
{Edit8->Color=clRed;
 Form6->Table1->FieldValues["wl"]=-atof(Form14->Edit8->Text.c_str());
 }
 else
...
{Edit11->Color=clRed;
 Form6->Table1->FieldValues["wl"]=-atof(Form14->Edit11->Text.c_str());
 }
 else
...
{Edit14->Color=clRed;
 Form6->Table1->FieldValues["wl"]=-atof(Form14->Edit14->Text.c_str());
 }
 else
...
{Edit17->Color=clRed;
 Form6->Table1->FieldValues["wl"]=-atof(Form14->Edit17->Text.c_str());
 }
 else
...
{Edit20->Color=clRed;
 Form6->Table1->FieldValues["wl"]=-atof(Form14->Edit20->Text.c_str());
 }
 else
...
{Edit23->Color=clRed;
 Form6->Table1->FieldValues["wl"]=-atof(Form14->Edit23->Text.c_str());
 }
 else
...
{Edit26->Color=clRed;
 Form6->Table1->FieldValues["wl"]=-atof(Form14->Edit26->Text.c_str());
 }
 else
...
{Edit29->Color=clRed;
 Form6->Table1->FieldValues["wl"]=-atof(Form14->Edit29->Text.c_str());
 }
 else
...
{Edit32->Color=clRed;
 Form6->Table1->FieldValues["wl"]=-atof(Form14->Edit32->Text.c_str());
 }
 else
...
{Edit35->Color=clRed;
 Form6->Table1->FieldValues["wl"]=-atof(Form14->Edit35->Text.c_str());
 }
 else
