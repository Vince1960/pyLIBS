...
Form9->Edit2->Text=FormatFloat("0.00E+00",atof(AnsiString(Form16->Edit1->Text).c_str())*1e17);
Form9->RadioGroup2->ItemIndex=2;
Form27->Edit8->Text=FormatFloat("0.00E+00",atof(AnsiString(Form16->Edit1->Text).c_str())*1e17);
Close();
}
//---------------------------------------------------------------------------
