...
if (Button==mbLeft && Shift.Contains(ssAlt) && Shift.Contains(ssCtrl))
 ...
 {
 SDIAppForm->Series2->AddXY(atof((SDIAppForm->Lambda_cursor->Caption).c_str()),atof((SDIAppForm->Intensity_cursor->Caption).c_str()),' ',clRed);
 ...
 {
 float xx=atof(Lambda_cursor->Caption.c_str());
identif(xx);
}
...
range=atof(OKBottomDlg->Edit9->Text.c_str());
 freq=atof(Lambda_cursor->Caption.c_str());
  Form5->Edit1->Text=Lambda_cursor->Caption.c_str();
...
void openfile(AnsiString nomefile);
  SDIAppForm->OpenDialog->FileName = "";
     SDIAppForm->OpenDialog->Filter = "Mechelle Files (*.mch)|*.mch|Avantes Files (*.trt)|*.trt|All Files (*.*)|*.*";
    AnsiString fp;
     SDIAppForm->OpenDialog->InitialDir=SDIAppForm->Edit14->Text;
    if (OpenDialog->Execute())
  {
  SDIAppForm->SaveDialog->FileName = SDIAppForm->OpenDialog->FileName;
...
//  SDIAppForm->Series5->Clear();
 ...
 SDIAppForm->Chart1->BottomAxis->Automatic=true;
  ...
  SDIAppForm->StatusBar->SimpleText="LIBS++ Software for Spectral Analysis (c) 1999-2010 CNR Applied Laser Spectroscopy Laboratory";
  ...
  do
   ...
   if ((wave <= atof(OKBottomDlg->Edit4->Text.c_str())) && (wave >= atof(OKBottomDlg->Edit3->Text.c_str()))) SDIAppForm->Series1->AddXY(wave+atof(OKBottomDlg->Edit23->Text.c_str()),lips,' ',clBlack);
   }
   }
   while (!feof(stream));
   close(handle);
...
(xx-SDIAppForm->Series1->XValues->Value[w]);
 break;
      ...
      switch(k)
                {
                case 0:
                a[2+k*4]=atof(Form14->Edit6->Text.c_str()); a[3+k*4]=atof(Form14->Edit7->Text.c_str())/2.; a[4+k*4]=atof(Form14->Edit8->Text.c_str())/2.;
                ...
                case 1:
                a[2+k*4]=atof(Form14->Edit9->Text.c_str()); a[3+k*4]=atof(Form14->Edit10->Text.c_str())/2.; a[4+k*4]=atof(Form14->Edit11->Text.c_str())/2.;
                ...
                case 2:
                a[2+k*4]=atof(Form14->Edit12->Text.c_str()); a[3+k*4]=atof(Form14->Edit13->Text.c_str())/2.; a[4+k*4]=atof(Form14->Edit14->Text.c_str())/2.;
                ...
                case 3:
                a[2+k*4]=atof(Form14->Edit15->Text.c_str()); a[3+k*4]=atof(Form14->Edit16->Text.c_str())/2.; a[4+k*4]=atof(Form14->Edit17->Text.c_str())/2.;
                ...
                case 4:
                a[2+k*4]=atof(Form14->Edit18->Text.c_str()); a[3+k*4]=atof(Form14->Edit19->Text.c_str())/2.; a[4+k*4]=atof(Form14->Edit20->Text.c_str())/2.;
                ...
                case 5:
                a[2+k*4]=atof(Form14->Edit21->Text.c_str()); a[3+k*4]=atof(Form14->Edit22->Text.c_str())/2.; a[4+k*4]=atof(Form14->Edit23->Text.c_str())/2.;
                ...
                case 6:
                a[2+k*4]=atof(Form14->Edit24->Text.c_str()); a[3+k*4]=atof(Form14->Edit25->Text.c_str())/2.; a[4+k*4]=atof(Form14->Edit26->Text.c_str())/2.;
                ...
                case 7:
                a[2+k*4]=atof(Form14->Edit27->Text.c_str()); a[3+k*4]=atof(Form14->Edit28->Text.c_str())/2.; a[4+k*4]=atof(Form14->Edit29->Text.c_str())/2.;
                ...
                case 8:
                a[2+k*4]=atof(Form14->Edit30->Text.c_str()); a[3+k*4]=atof(Form14->Edit31->Text.c_str())/2.; a[4+k*4]=atof(Form14->Edit32->Text.c_str())/2.;
                ...
                case 9:
                a[2+k*4]=atof(Form14->Edit33->Text.c_str()); a[3+k*4]=atof(Form14->Edit34->Text.c_str())/2.; a[4+k*4]=atof(Form14->Edit35->Text.c_str())/2.;
...
void compfile(AnsiString nomefile);
  ...
  OpenDialog->FileName = "";
     OpenDialog->Filter = "Mechelle Files (*.mch)|*.mch|Avantes Files (*.trt)|*.trt|All Files (*.*)|*.*";
...
Form28->Show();
    ...
    if (SDIAppForm->Series1->XValues->Value[w] > xmax) xmax=SDIAppForm->Series1->XValues->Value[w];
      ...
      npoints=Series1->LastValueIndex-Series1->FirstValueIndex;
...
float de=atof(OKBottomDlg->Edit2->Text.c_str());
  float ha=6563.;
   int group = atof(OKBottomDlg->Edit1->Text.c_str());
  ...
  MySeries->LinePen->Style=psDot;
   ...
   for ( count=0; count < maxcount; count++)
   {
       ...
       plotvoigt(xx[g],a,&y,na);
        ...
        double wtot=sqrt(pow(glwlor/2,2)+pow(wgau,2))+glwlor/2;
        double inst=atof(OKBottomDlg->Edit16->Text.c_str())/5000.*a[2];
        glwlor=wtot-pow(inst,2)/wtot;
...
double Ne(float,float,float);
 ...
 float minax,maxax,minay,maxay;
float de=atof(OKBottomDlg->Edit2->Text.c_str());
  float ha=atof(OKBottomDlg->Edit5->Text.c_str());
   int group = atof(OKBottomDlg->Edit1->Text.c_str());
...
/* inserimento condizioni iniziali*/
     ...
     if (k==0)
     {
     a[2+k*4]=atof(OKBottomDlg->Edit5->Text.c_str());
     a[4+k*4]=atof(OKBottomDlg->Edit12->Text.c_str());
     a[1+k*4]=(SDIAppForm->Series1->MaxYValue()-a[0]-a[2+k*4]*a[na])*(a[3+k*4]+a[4+k*4])*6.28;
     }
      else
      {
      a[4+k*4]=atof(OKBottomDlg->Edit24->Text.c_str());
      a[2+k*4]=atof(OKBottomDlg->Edit6->Text.c_str());
      a[1+k*4]=(SDIAppForm->Series1->MaxYValue()/10.-a[0]-a[2+k*4]*a[na])*(a[3+k*4]+a[4+k*4])*6.28;
      }
  ...
  MySeries->LinePen->Style=psDot;
   ...
   for ( count=0; count < maxcount; count++)
   {
       ...
       plotvoigt(xx[g],a,&y,na);
        ...
        glwlor=wtot-pow(inst,2)/wtot;
        float ne=2.84e15*pow(glwlor,1.5);
        float T=11600*atof(OKBottomDlg->Edit25->Text.c_str());
