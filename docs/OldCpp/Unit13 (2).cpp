...
{
   MySeries->AddXY(SDIAppForm->Chart1->Series[ru]->XValues->Value[q],SDIAppForm->Chart1->Series[ru]->YValues->Value[q]+atof(Form13->Edit2->Text.c_str()),' ',colo[sc-6]);
 }
...
for (int q=0; q < SDIAppForm->Chart1->Series[ru]->Count();q++)
{
   MySeries->AddXY(SDIAppForm->Chart1->Series[ru]->XValues->Value[q],SDIAppForm->Chart1->Series[ru]->YValues->Value[q]*atof(Form13->Edit3->Text.c_str()),' ',colo[sc-6]);
 }
